...
import com.xrontech.web.Application;
...
public class AttendanceService {
    ...
    private final Application employeeManagementApplication;

    private User currentUser;

//    private User getCurrentUser() {
//        currentUser = employeeManagementApplication.checkCurrentUser();
//        employeeManagementApplication.checkAccountStatus(currentUser);
//        return currentUser;
//    }
...
//        getCurrentUser();
//        employeeManagementApplication.checkAccountStatus(currentUser);
//        employeeManagementApplication.checkAuthorization(currentUser);
